...
print(get("http://alex-raz-project.herokuapp.com/api/users").json())  # получение всех пользователей
print(get("http://alex-raz-project.herokuapp.com/api/users/1").json())  # корректный запрос на получение работы по id
print(get("http://alex-raz-project.herokuapp.com/api/users/21").json())  # несуществующий id
print(get("http://alex-raz-project.herokuapp.com/api/users/s").json())  # некорректный id
