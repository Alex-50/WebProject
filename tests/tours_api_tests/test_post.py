...
print(post("http://alex-raz-project.herokuapp.com/api/tours",
           json={"id": 7, "name": "Экскурсия по Санкт-Петербургу",
...
print(post("http://alex-raz-project.herokuapp.com/api/tours").json())  # пустой словарь
